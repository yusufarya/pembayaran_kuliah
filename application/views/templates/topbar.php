        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="bg-content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light bg-transparant topbar mb-4 static-top shadow-lg">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-900 small">Hallo... <strong><?php echo $user['nama'] ?></strong></span>
